...
Debug.AddCard(10051321,0,0,LOCATION_HAND,0,POS_FACEDOWN)
...
Debug.AddCard(10055612,0,0,LOCATION_HAND,0,POS_FACEDOWN)
Debug.AddCard(10054621,0,0,LOCATION_HAND,0,POS_FACEDOWN)
Debug.AddCard(10055114,0,0,LOCATION_HAND,0,POS_FACEDOWN)

Debug.AddCard(10054521,1,1,LOCATION_HAND,0,POS_FACEDOWN)
...
What~!! 에토와리아에도 시험이 있는겁니까?]]
Debug.ShowHint[[★클레어
걱정마세요~! 여기까지 오셨다면 하실 수 있을거예요
지금까지 배운 것들을 떠올려보세요]]
Debug.ShowHint[[★램프
맞아요~! 크리에메이트 님들이라면 가능해요~!]]
